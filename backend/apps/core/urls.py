...
from .views import (
    ...
    DocumentFolderRetrieveDestroyAPIView,
...
urlpatterns = [
    ...
    path('documents/folders/<uuid:uuid>/', DocumentFolderRetrieveDestroyAPIView.as_view(), name='core-documents-folders-detail-api'),
